      ...
      content: [
        {
          ...
          text:
            ...
            `-\n` +
            `- Advanced:\n` +
            `-- Execute multiple actions sequentially: Use callMultipleToolsAtOnce for efficiency, especially for related operations. Group actions logically.\n` +
            `-- use callMultipleToolsAtOnce to minimize the number of tools calls. always break down your task into smaller tasks and use callMultipleToolsAtOnce to execute them. \n` +
            `-- Memory:\n` +
