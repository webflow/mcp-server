// Generated by Wrangler by running `wrangler types` (hash: 7a300854185032f86f67cb0487b07fad)
// Runtime types generated with workerd@1.20250408.0 2025-04-09 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		MCP_OBJECT: DurableObjectNamespace<import("./src/index.worker").WebflowMcpAgent>;
	}
}
