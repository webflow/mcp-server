// Generated by Wrangler by running `wrangler types` (hash: cec888cce43fbaa0dbc77bafa8a252d5)
...
declare namespace Cloudflare {
	interface Env {
		...
		MCP_OBJECT: DurableObjectNamespace<import("./src/index.worker").WebflowMcp>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WEBFLOW_CLIENT_ID" | "WEBFLOW_CLIENT_SECRET" | "COOKIE_ENCRYPTION_KEY">> {}
}
